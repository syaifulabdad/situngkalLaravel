...
@section('content')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title form-inline">
                        ...
                        <input id="bulan" type="month" class="form-control mr-3" onchange="reload()">
    ...
    <div class="modal" id="modal-import">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('ptk-import-excel') }}" method="POST" id="form-import" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        $('.btnDownload').click(function() {
            ...
            window.location.href = "{{ route('ptk-unduh-excel') }}?kecamatan_id=" + kecamatan_id + "&sekolah_id=" + sekolah_id;
        })
